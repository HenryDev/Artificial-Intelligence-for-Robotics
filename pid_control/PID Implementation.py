...
def run(param1, param2, param3):
    ...
    for i in range(N):
        ...
        cte_sum += cross_track_error
        cte_differential = cross_track_error - cte_old
        steering_angle = -param1 * cross_track_error - param2 * cte_differential - param3 * cte_sum
        myrobot = myrobot.move(steering_angle, speed)
        cte_old = cross_track_error
